                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="sidebarCollapse">
                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="student.jsp">
                        ...
                        <div class="mb-npx">
                            <div class="row align-items-center">
                                ...
                                <div class="col-sm-6 col-12 text-sm-end">
                                    <div class="mx-n1">
                                        <a href="createstudents.jsp" class="btn d-inline-flex btn-sm btn-primary mx-1">
                                            <span class=" pe-2">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow border-0 mb-7">
                            <div class="card-header">
                                <h5 class="mb-0">Danh sách các bài viết về Sinh Viên</h5>
                            </div>
