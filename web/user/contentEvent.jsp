<%-- 
    Document   : contentEvent
    Created on : Feb 13, 2022, 11:35:19 AM
    Author     : Admin
--%>
            ...
            <div class="wrap_content">
                <div class="main_contain">
                    ...
                    <div class="heading-section padding-top-86px">
                        <div class="site_map"><a href="../Homepage/homepage.html">Trang chủ > </a><a href="../Event/event.html">Sự kiện > </a><a href="#">FPT Edu Hackathon 2021</a></div>
                        <h3 class="sub-heading">FPT Edu Hackathon 2021</h3>   
                        <ul class="text-info">
                            <li>Thời gian: 11/9/2021</li>
                    ...
                    <div class="main_contain-text para-heading--two-row">
                        <img src='../Homepage/assets/images/1.jpg'></img>
                    </div>
                    <div class="main_contain-text para-heading--two-row">
                        <p>
                            Tại Đại học FPT, Kỹ thuật phần mềm là chuyên ngành học có tiếng và lâu đời nhất. Hiện tại, sinh
