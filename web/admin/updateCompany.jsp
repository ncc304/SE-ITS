                            ...
                            <div class="card-footer border-0 py-5">
                                <form method="POST" action="${pageContext.request.contextPath}/MainController" id="formSubmit">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="upload" type="file" name="logo" value="${dto.link}" onchange="readURL(this);" class="form-control" style="width: auto;">
                                        <br/>
                                        <div class="image-area">
                                            <img id="imageResult"
                                                 src="${pageContext.request.contextPath}/user/assets/images/${dto.link}"
                                                 alt=""
                                    ...
                                    <div class="form-group">
                                        <label>Địa chỉ</label>
                                        <input type="text" value="${dto.address}" class="form-control" name="txtAddress">
                                    </div>
                                    ...
                                    <br/><br/><br/>
                                    <input type="submit" value="Sửa công ty" name="action" id="btnCreate" class="btn btn-warning" style="margin-left: 45%"></input>
                                </form>
                            </div>
                        </div>
                    </div>
