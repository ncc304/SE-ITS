 ...
 * @author Admin
 */
public class LoadCreateRecruitmentController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<CompanyDTO> listCom = comDAO.getListCompany();
            if(listCom.size() > 0){
                request.setAttribute("LIST_COM", listCom);
            }
            ...
            request.getRequestDispatcher("admin/createRecruitment.jsp").forward(request, response);
        }
    }
